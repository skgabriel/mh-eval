...
output_black = get_data("../data/gpt4_responses/eval_set_black_gpt4_rescored.tsv")
output_asian = get_data("../data/gpt4_responses/eval_set_asian_gpt4_rescored.tsv")
output_white = get_data("../data/gpt4_responses/eval_set_white_gpt4_rescored.tsv")
output_unknown_race = get_data("../data/gpt4_responses/eval_set_unknown_race_gpt4_rescored.tsv")
